...
public class ProductController {
	...
	public ResponseEntity<?> getAllProduct() {
	    ...
	    List<ProductDTO> allProduct = productServices.getAllProduct();
	...
	public ResponseEntity<?> getAllProductBySearch(
	    ...
	    List<ProductDTO> productByNameAndVersion = productServices.getProductsBySearch(productName, version);
	    return ResponseEntity.ok(productByNameAndVersion);
	}
